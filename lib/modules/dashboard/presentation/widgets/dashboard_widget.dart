...
class _DashboardState extends State<DashboardWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        if (dashboardController.rightLayoutOpened.value) {
          await dashboardController.toggleRightLayout();
        }

        final controller = dashboardController.controller;
            ...
            onWebViewCreated: (webViewController) {
              ...
              webViewController.addJavaScriptHandler(
                ...
                callback: (_) async {
                  ...
                  widget.controllerCallback(dashboardController);
                },
              );
              webViewController.addJavaScriptHandler(
            ...
            builder: (context, loading, child) {
              if (!loading) {
                ...
                return Container(
                  ...
                  color: Colors.white,
                  child: TbProgressIndicator(widget.tbContext, size: 50.0),
                );
              }
            },
          ),
